<aside class="main-sidebar">
	<section class="sidebar">
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="
						{{ Request::segment(1) === null ? 'active' : null }}
						{{ Request::segment(1) === 'teacher' ? 'active' : null }}
					  ">
				<a href="{{ url('teachers') }}" title="Teacher"><i class="fa fa-dashboard"></i> <span> Teacher</span></a>
			</li>
			<li class="
						{{ Request::segment(1) === null ? 'active' : null }}
						{{ Request::segment(1) === 'student' ? 'active' : null }}
					  ">
				<a href="{{ url('students') }}" title="Student"><i class="fa fa-dashboard"></i> <span> Student</span></a>
			</li>
			<li class="
						{{ Request::segment(1) === null ? 'active' : null }}
						{{ Request::segment(1) === 'assign' ? 'active' : null }}
					  ">
				<a href="{{ url('assign') }}" title="Assign"><i class="fa fa-dashboard"></i> <span> Assign</span></a>
			</li>
